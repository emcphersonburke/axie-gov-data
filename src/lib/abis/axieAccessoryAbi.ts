...
export const axieAccessoryAbi: AbiItem[] = [
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'bytes[]', name: 'extraDatas', type: 'bytes[]' },
        ],
        indexed: false,
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint128', name: '_collectionTypeId', type: 'uint128' },
      { internalType: 'uint128', name: '_typedCollectionId', type: 'uint128' },
    ],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint128', name: '_balance', type: 'uint128' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_operator', type: 'address' },
      { internalType: 'uint256', name: '_tokenId', type: 'uint256' },
      { internalType: 'bytes4', name: '_methodId', type: 'bytes4' },
    ],
    name: 'isAuthorized',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    stateMutability: 'view',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes[]', name: '_extraDatas', type: 'bytes[]' },
    ],
