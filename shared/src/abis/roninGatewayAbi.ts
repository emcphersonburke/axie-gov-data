...
export const roninGatewayAbi: AbiItem[] = [
  ...
  { inputs: [], name: 'ErrQueryForTooSmallQuantity', type: 'error' },
  {
    inputs: [
      {
        components: [
          { internalType: 'enum Token.Standard', name: 'erc', type: 'uint8' },
  ...
  },
  {
    inputs: [
      { internalType: 'bytes4', name: 'msgSig', type: 'bytes4' },
      { internalType: 'enum RoleAccess', name: 'expectedRole', type: 'uint8' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_trustedNumerator', type: 'uint256' },
      { internalType: 'uint256', name: '_trustedDenominator', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'address[]', name: '_roninTokens', type: 'address[]' },
      {
        internalType: 'address[]',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256[]', name: '_thresholds', type: 'uint256[]' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: '_withdrawalIds', type: 'uint256[]' },
    ],
    name: 'tryBulkAcknowledgeMainchainWithdrew',
    outputs: [
      { internalType: 'bool[]', name: '_executedReceipts', type: 'bool[]' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
